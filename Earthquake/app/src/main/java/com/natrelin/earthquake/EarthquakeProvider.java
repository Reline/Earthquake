...
public class EarthquakeProvider extends ContentProvider {
    ...
    static {
        ...
        uriMatcher.addURI("com.natrelin.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_QUERY,
                SEARCH);
        uriMatcher.addURI("com.natrelin.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_QUERY +
                "/*", SEARCH);
        uriMatcher.addURI("com.natrelin.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_SHORTCUT,
            SEARCH);
        uriMatcher.addURI("com.natrelin.earthquakeprovider",
    ...
    static {
        ...
        SEARCH_PROJECTION_MAP.put(SearchManager.SUGGEST_COLUMN_TEXT_1, KEY_SUMMARY + " AS " +
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Log.i(TAG, "Cursor(0)" + c.getColumnName(0));
        return c;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            case QUAKES:
                count = database.delete(EarthquakeDatabaseHelper.EARTHQUAKE_TABLE, selection,
                        selectionArgs);
                break;
            case QUAKE_ID:
